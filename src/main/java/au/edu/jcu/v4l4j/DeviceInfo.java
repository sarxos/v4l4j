 ...
 * {@link VideoDevice#getDeviceInfo()} on its <code>VideoDevice</code> object,
 * and retrieve parameters of interest. Example:<br>
 * <code>
 ...
 * VideoDevice object has been released. Calling any methods will then throw a
 * {@link StateException}.
 * 
 * @author gilles
 * 
...
public class DeviceInfo {
	...
	/**
	 * This method returns an {@link ImageFormatList} object containing the
	 * various image formats, capture resolutions and frame intervals the video
	 * device supports.
	 * 
	 ...
	 * currently being used by another application and frame intervals cannot be
	 * enumerated at this time.</b><br>
	 * Frame interval information can also be obtained through
	 * {@link ResolutionInfo} objects, attached to each {@link ImageFormat}. See
	 * {@link #getFormatList()}.
	 * 
	 * @return a {@link FrameInterval} object containing information about the
